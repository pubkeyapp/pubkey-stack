...
import {
  IdentityUiGithubLinkButton,
  IdentityUiTelegramLinkButton,
  IdentityUiTwitterLinkButton,
} from './identity-ui-github-link-button'
      ...
      {grouped.map((group) => (
        <UiStack key={group.provider}>
          <Group justify="space-between">
            ...
            {group.provider === IdentityProvider.Telegram && <IdentityUiTelegramLinkButton size="sm" w={210} />}
